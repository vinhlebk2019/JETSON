...
# Config ROI (mask) 
cfg_mask_width_factor = 3.8 
cfg_mask_height_factor = 2.8
cfg_mask_height_derating_factor = 0.5
cfg_mask_center_shift_factor = 0.7
cfg_mask_devidied = 6
cfg_mask_offset_factor = 1.6
...
def extract_colour(img):
    ...
    sensitivity_hmax = 35 #40 #51 # cang nho cang den bau troi
...
arr_moving_average_0 = [10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000]
        ...
        if ret:
            ...
            if (using_houghLine_flag == 1):
                ...
                if (x_c1 != invalid_value) and (x_c2 != invalid_value):
                    ...
                    if (abs(x_c1 - x_center1) > 100) or (abs(x_c2 - x_center2) > 100):
                        x_c1 = x_center1
                        x_c2 = x_center2
            ...
            lane_detection_data.curvature = finalCurvature
...
if __name__ == '__main__':
    ...
    video_name = "/home/ubuntu/aev/videos/20220603/2.mp4"
