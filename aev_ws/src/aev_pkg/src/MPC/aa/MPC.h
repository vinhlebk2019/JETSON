...
class MPCModelClass {
 ...
 public:
  ...
  typedef const struct tag_ConstB_MPC_T {
  ...
  typedef struct {
    ...
    real_T CurvaturePreview[3];        // '<Root>/CurvaturePreview'
  ...
  void setExternalInputs(const ExtU_MPC_T* pExtU_MPC_T)
  {
    MPC_U = *pExtU_MPC_T;
  }
  ...
  const MPCModelClass::ExtY_MPC_T & getExternalOutputs() const
  {
    return MPC_Y;
  }

  // Real-Time Model get method
  MPCModelClass::RT_MODEL_MPC_T * getRTM();
 ...
 private:
  ...
  // Block states
  DW_MPC_T MPC_DW;
  X_MPC_T MPC_X;                       // Block continuous states
  ...
  // Real-Time Model
  RT_MODEL_MPC_T MPC_M;

  // private member function(s) for subsystem '<Root>'
  void MPC_lusolve(const real_T A[16], const real_T B[16], real_T X[16]);
  void MPC_PadeApproximantOfDegree(const real_T A[16], uint8_T m, real_T F[16]);
  void MPC_expm(real_T A[16], real_T F[16]);
  void MPC_emxInit_real_T(emxArray_real_T_MPC_T **pEmxArray, int32_T
    numDimensions);
  void MPC_emxEnsureCapacity_real_T(emxArray_real_T_MPC_T *emxArray, int32_T
    oldNumel);
  void MPC_emxFree_real_T(emxArray_real_T_MPC_T **pEmxArray);
  void MPC_emxFree_boolean_T(emxArray_boolean_T_MPC_T **pEmxArray);
  void MPC_emxInit_int16_T(emxArray_int16_T_MPC_T **pEmxArray, int32_T
    numDimensions);
  void MPC_emxEnsureCapacity_int16_T(emxArray_int16_T_MPC_T *emxArray, int32_T
    oldNumel);
  real_T MPC_norm(const real_T x_data[], const int32_T *x_size);
  void MPC_abs_d(const emxArray_real_T_MPC_T *x, emxArray_real_T_MPC_T *y);
  void MPC_maximum2(const emxArray_real_T_MPC_T *x, emxArray_real_T_MPC_T *ex);
  real_T MPC_xnrm2(int32_T n, const real_T x_data[], int32_T ix0);
  void MPC_xgemv(int32_T b_m, int32_T n, const real_T b_A_data[], int32_T ia0,
                 int32_T lda, const real_T x_data[], int32_T ix0, real_T y_data[]);
  void MPC_xgerc(int32_T b_m, int32_T n, real_T alpha1, int32_T ix0, const
                 real_T y_data[], real_T b_A_data[], int32_T ia0, int32_T lda);
  void MPC_qrf(real_T b_A_data[], const int32_T b_A_size[2], int32_T b_m,
               int32_T n, int32_T nfxd, real_T tau_data[]);
  void MPC_xgeqrf(real_T b_A_data[], int32_T b_A_size[2], real_T tau_data[],
                  int32_T *tau_size);
  void MPC_xorgqr(int32_T b_m, int32_T n, int32_T k, real_T b_A_data[], const
                  int32_T b_A_size[2], int32_T lda, const real_T tau_data[]);
  void MPC_qr(const real_T b_A_data[], const int32_T b_A_size[2], real_T Q_data[],
              int32_T Q_size[2], real_T R_data[], int32_T R_size[2]);
  void MPC_mtimes_ojosf(const real_T b_A_data[], const int32_T b_A_size[2],
                        const real_T b_B_data[], real_T b_C_data[], int32_T
                        *b_C_size);
  real_T MPC_KWIKfactor(const emxArray_real_T_MPC_T *b_Ac, const int16_T
                        iC_data[], int16_T nA, const real_T Linv_data[], const
                        int32_T Linv_size[2], real_T RLinv_data[], const int32_T
                        RLinv_size[2], real_T b_D_data[], const int32_T
                        b_D_size[2], real_T b_H_data[], const int32_T b_H_size[2],
                        int16_T n);
  void MPC_abs(const real_T x_data[], const int32_T x_size[2], real_T y_data[],
               int32_T y_size[2]);
  void MPC_qpkwik(const real_T Linv_data[], const int32_T Linv_size[2], const
                  real_T Hinv_data[], const int32_T Hinv_size[2], const real_T
                  f_data[], const emxArray_real_T_MPC_T *b_Ac, const
                  emxArray_real_T_MPC_T *b, emxArray_int16_T_MPC_T *iA, int16_T
                  b_m, int16_T n, real_T x_data[], int32_T *x_size, real_T
                  lambda_data[], int32_T *lambda_size, real_T *status);
  void MPC_emxFree_int16_T(emxArray_int16_T_MPC_T **pEmxArray);
  void MPC_mpc_solveQP(const real_T xQP[5], real_T nCon, real_T b_degrees, const
                       real_T Kx_data[], const real_T Kr_data[], const int32_T
                       Kr_size[2], const emxArray_real_T_MPC_T *rseq, const
                       real_T Ku1_data[], real_T old_u, const real_T Kv_data[],
                       const int32_T Kv_size[2], const emxArray_real_T_MPC_T
                       *vseq, const real_T Kut_data[], const int32_T Kut_size[2],
                       const real_T b_utarget_data[], const real_T Linv_data[],
                       const int32_T Linv_size[2], const real_T Hinv_data[],
                       const int32_T Hinv_size[2], const emxArray_real_T_MPC_T
                       *b_Ac, const emxArray_real_T_MPC_T *Bc, const
                       emxArray_boolean_T_MPC_T *iA, real_T zopt_data[], int32_T
                       *zopt_size, real_T f_data[], int32_T *f_size, real_T
                       *status);
  void MPC_emxEnsureCapacity_boolean_T(emxArray_boolean_T_MPC_T *emxArray,
    int32_T oldNumel);
  void MPC_mtimes_o(const real_T b_A_data[], const int32_T b_A_size[2], const
                    real_T b_B_data[], const int32_T b_B_size[2], real_T
                    b_C_data[], int32_T b_C_size[2]);
  void MPC_emxInit_boolean_T(emxArray_boolean_T_MPC_T **pEmxArray, int32_T
    numDimensions);
  void MPC_mtimes_ojos(const emxArray_real_T_MPC_T *b_A, const
                       emxArray_real_T_MPC_T *b_B, emxArray_real_T_MPC_T *b_C);
  void MPC_mtimes_ojo(const emxArray_real_T_MPC_T *b_A, const real_T b_B[5],
                      emxArray_real_T_MPC_T *b_C);
  void MPC_trisolve(const real_T b_A_data[], const int32_T b_A_size[2], real_T
                    b_B_data[], const int32_T b_B_size[2]);
  void MPC_linsolve(const real_T b_A_data[], const int32_T b_A_size[2], const
                    real_T b_B_data[], const int32_T b_B_size[2], real_T
                    b_C_data[], int32_T b_C_size[2]);
  void MPC_eye_g(real_T varargin_1, real_T b_I_data[], int32_T b_I_size[2]);
  int32_T MPC_xpotrf(int32_T n, real_T b_A_data[], int32_T lda);
  void MPC_diag(const real_T v_data[], const int32_T v_size[2], real_T d_data[],
                int32_T *d_size);
  real_T MPC_minimum(const real_T x_data[], const int32_T *x_size);
  void MPC_mpc_checkhessian(real_T b_H_data[], const int32_T b_H_size[2], real_T
    L_data[], int32_T L_size[2], real_T *BadH);
  void MPC_WtMult(const real_T M_data[], const int32_T M_size[2], real_T
                  WM_data[], int32_T WM_size[2]);
  void MPC_WtMult_l(const real_T M_data[], const int32_T M_size[2], real_T
                    WM_data[], int32_T WM_size[2]);
  void MPC_WtMult_lm(const real_T M_data[], const int32_T M_size[2], real_T
                     WM_data[], int32_T WM_size[2]);
  void MPC_mtimes_oj(const real_T b_A_data[], const int32_T *b_A_size, const
                     real_T b_B_data[], const int32_T b_B_size[2], real_T
                     b_C_data[], int32_T b_C_size[2]);
  void MPC_mpc_calculatehessian(const real_T SuJm_data[], const int32_T
    ...
    int32_T *I1_size, const real_T Su1_data[], const int32_T *Su1_size, const
    ...
    int32_T Kr_size[2]);
  void MPC_eye(real_T varargin_1, real_T b_I_data[], int32_T b_I_size[2]);
  void MPC_mtimes(const real_T b_A_data[], const int32_T b_A_size[2], const
                  real_T b_B_data[], const int32_T b_B_size[2], real_T b_C_data[],
                  int32_T b_C_size[2]);
  void MPC_kron_b(const real_T b_A_data[], const int32_T b_A_size[2], real_T
                  K_data[], int32_T K_size[2]);
  void MPC_tril(real_T x_data[], const int32_T x_size[2]);
  int32_T MPC_combineVectorElements(const boolean_T x_data[], const int32_T
    *x_size);
  void MPC_Mrows_reshape_lgbo5(boolean_T isMrows_data[], real_T Mlimfull_data[],
    real_T Vfull_data[], const boolean_T isMrows0[34], const real_T Mlimfull0[34],
    const real_T Vfull0[34], real_T b_p, real_T ioff);
  void MPC_Mrows_reshape_lgbo(boolean_T isMrows_data[], real_T Mlimfull_data[],
    real_T Vfull_data[], const boolean_T isMrows0[34], const real_T Mlimfull0[34],
    const real_T Vfull0[34], real_T b_p, real_T ioff);
  void MPC_Mrows_reshape_lgb(boolean_T isMrows_data[], real_T Mlimfull_data[],
    real_T Vfull_data[], const boolean_T isMrows0[34], const real_T Mlimfull0[34],
    const real_T Vfull0[34], real_T b_p, real_T ioff);
  void MPC_Mrows_reshape_lg(boolean_T isMrows_data[], real_T Mlimfull_data[],
    real_T Vfull_data[], const boolean_T isMrows0[34], const real_T Mlimfull0[34],
    const real_T Vfull0[34], real_T b_p, real_T ioff);
  void MPC_repmat_d(const boolean_T a[2], real_T varargin_1, boolean_T b_data[],
                    int32_T *b_size);
  void MPC_repmat_dl(const real_T a[2], real_T varargin_1, real_T b_data[],
                     int32_T *b_size);
  void MPC_Mrows_reshape_l(boolean_T isMrows_data[], real_T Mlimfull_data[],
    real_T Vfull_data[], const boolean_T isMrows0[34], const real_T Mlimfull0[34],
    const real_T Vfull0[34], real_T b_p, real_T ioff);
  void MPC_Mrows_reshape(boolean_T isMrows_data[], real_T Mlimfull_data[],
    real_T Vfull_data[], const boolean_T isMrows0[34], const real_T Mlimfull0[34],
    const real_T Vfull0[34], real_T b_p);
  void MPC_mpc_constraintcoef(const real_T b_A[25], const real_T Bu[5], const
    real_T Bv[10], const real_T b_C[10], const real_T Dv[4], const real_T
  ...
  void MPC_repmat(real_T a, real_T varargin_1, real_T b_data[], int32_T *b_size);
  void MPC_kron(const int32_T *b_A_size, real_T K_data[], int32_T *K_size);
  void MPC_mpcblock_optimizerPM(const emxArray_real_T_MPC_T *rseq, const
    emxArray_real_T_MPC_T *vseq, real_T umin, real_T umax, real_T switch_in,
    ...
    const emxArray_real_T_MPC_T *Bu, const emxArray_real_T_MPC_T *Bv, const
    real_T b_C[10], const emxArray_real_T_MPC_T *Dv, real_T *u, real_T useq[11],
    real_T *status);
  ...
  void MPC_derivatives();
};

extern const MPCModelClass::ConstB_MPC_T MPC_ConstB;// constant block i/o

// Constant parameters (default storage)
extern const MPCModelClass::ConstP_MPC_T MPC_ConstP;
